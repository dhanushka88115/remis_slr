...
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('admin1',1100001,'admin1',2,0,'superadmin1','2021-03-20 10:55:36','admin1','2022-09-09 16:00:09',NULL,NULL);
