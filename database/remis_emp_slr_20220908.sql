...
) ENGINE=InnoDB AUTO_INCREMENT=1100036 DEFAULT CHARSET=latin1;
...
insert  into `employee`(`Id`,`NICNumber`,`FirstName`,`LastName`,`address`,`DateOfBirth`,`GenderId`,`SubDepartmentId`,`SectionId`,`DesignationId`,`CabinetOfficeId`,`DesignationTypeId`,`ServiceLevelId`,`ServiceCategoryId`,`ClassGradeId`,`AppointmentDate`,`AppointmentDateToSLR`,`RetirementDate`,`SalaryStructureId`,`EmployeeStatusId`,`ComputerNo`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values (1100035,'1234567890','gfhgfh','gfggfh','fghgfgf','2022-09-08',1,1,2,2,11,1,1,1,1,'2022-09-10','2022-09-11','2022-09-09',1,1,'1212',1,'admin1','2022-09-08 10:53:23',NULL,NULL,'admin1','2022-09-08 15:29:59');
...
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('admin1',1100001,'admin1',2,0,'superadmin1','2021-03-20 10:55:36','admin1','2022-09-07 08:09:58',NULL,NULL);
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('qq',1100035,'qq',2,1,'admin1','2022-09-08 14:20:45',NULL,NULL,'admin1','2022-09-08 14:28:56');
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('superadmin1',1100000,'superadmin1',1,0,'superadmin1','2022-02-16 10:49:40','superadmin1','2022-09-05 06:09:42',NULL,NULL);
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('superuser1',1100002,'superuser1',3,0,'superadmin1','2022-02-16 10:49:18','superadmin1','2022-02-16 10:49:18',NULL,NULL);
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('user1',1100003,'user1',4,0,'superadmin1','2022-02-16 10:49:40','superadmin1','2022-09-05 06:09:42',NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `employeewithuserview` AS (select `u`.`Username` AS `Username`,`u`.`EmployeeId` AS `EmployeeId`,`e`.`FirstName` AS `FirstName`,`e`.`LastName` AS `LastName`,`u`.`Password` AS `Password`,`u`.`RoleId` AS `RoleId`,`u`.`IsDeleted` AS `IsDeleted`,`r`.`RoleName` AS `RoleName`,`e`.`CabinetOfficeId` AS `CabinetOfficeId`,`c`.`CabinetOfficeName` AS `CabinetOfficeName` from (((`user` `u` left join `employee` `e` on((`u`.`EmployeeId` = `e`.`Id`))) left join `role` `r` on((`u`.`RoleId` = `r`.`Id`))) left join `cabinetoffice` `c` on((`e`.`CabinetOfficeId` = `c`.`Id`))) where (`e`.`IsDeleted` = 0)) */;
