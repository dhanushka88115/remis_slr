...
insert  into `subdepartment`(`Id`,`SubDepartmentCode`,`SubDepartmentName`,`Address`,`HeadofDepartmentId`,`IsDeleted`,`UpdatedBy`,`UpdatedTime`,`CreatedBy`,`CreatedTime`) values (1,'GMR','General Manager\'s Office','Maradana-HQ',1100000,0,'System','2021-03-20 10:55:35','System','2021-03-20 10:55:35');
...
insert  into `user`(`Username`,`EmployeeId`,`Password`,`RoleId`,`IsDeleted`,`CreatedBy`,`CreatedTime`,`UpdatedBy`,`UpdatedTime`,`DeletedBy`,`DeletedTime`) values ('admin1',1100001,'admin1',2,0,'superadmin1','2021-03-20 10:55:36','admin1','2022-09-14 14:23:29',NULL,NULL);
